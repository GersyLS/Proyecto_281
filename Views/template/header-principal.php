    ...
    <div class="container text-light">
      <div class="w-100 d-flex justify-content-between">
        <div>
          ...
          <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:info.angel@gmail.com">jaime.0410j@gmail.com</a>
          <i class="fa fa-phone mx-2"></i>
          <a class="navbar-sm-brand text-light text-decoration-none" href="tel:900 897 537">75806582</a>
        </div>
        <div>
        ...
        <div class="navbar align-self-center d-flex">
          ...
          <?php if (!empty($_SESSION['correoCliente'])) { ?>
            <a class="nav-icon position-relative text-decoration-none" href="<?php echo BASE_URL . 'clientes' ?>">
              <img class="img-thumbnail" src="<?php echo BASE_URL . 'assets/images/clientes/usuario.png' ?>" alt="-LOGO-CLIENTE" width="50">
            </a>
          <?php } else { ?>
